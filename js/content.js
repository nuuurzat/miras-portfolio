/* ============================================================
   САЙТ КОНТЕНТІ — мұнда өз деректеріңізді жазыңыз.
   3 тіл: kk (қазақша), ru (орысша), en (ағылшынша).
   Кейстер жалпы CASE_FILES тізімінен автоматты жасалады:
   әр видео — жеке кейс, атауы = файл атауы.
   Жаңа видео қоссаңыз: файлды portfolio/img/ қапшығына
   салып, CASE_FILES-ке бір жол қосыңыз.
   ============================================================ */

// --- Кейс видеолары (барлық тілде бірдей) ---
// src — img/ қапшығына қатысты жол; poster — видео постері (қажет емес)
const CASE_FILES = [
...
window.PORTFOLIO_DATA = {
  ...
  // --- Байланыс (барлық тілде бірдей) ---
  contacts: {
    email: "",                      // email жоқ болса — үлкен блокта телефон көрсетіледі
    phone: "+7 776 921-86-32",      // Көрінетін нөмір
    phoneHref: "+77769218632",      // tel: сілтемесіндегі нөмір
    telegram: "miraskhmt",          // Telegram хэндл
    telegramHref: "https://t.me/miraskhmt",
    instagram: "miraskhmt",         // Instagram хэндл
    instagramHref: "https://www.instagram.com/miraskhmt/"
  },

  // --- Серіктес компаниялар / адамдар (marquee, барлық тілде бірдей) ---
  companies: [
    { name: "ХБМ (kzchemistry)", href: "https://www.instagram.com/kzchemistry/" },
    { name: "Сая Қыдырәлі", href: "https://www.instagram.com/saya.kidirali/" },
    { name: "Envy studios", href: "https://www.instagram.com/envy.studios/" },
    { name: "Sham studio", href: "https://www.instagram.com/shamstudio.kz/" },
    { name: "Rent car Almaty", href: "https://www.instagram.com/rentcaralmaty/" },
    { name: "Bastau Brand", href: "https://www.instagram.com/bastau.brand/" },
    { name: "Study Point", href: "https://www.instagram.com/studypoint_kz/" },
    { name: "Astabaq", href: "https://www.instagram.com/astabaq.kz/" },
    { name: "Sevalo.kz", href: "https://www.instagram.com/sevalo.kz/" }
  ],
  ...
  languages: {
    ...
    kk: {
      ui: {
        nav: { cases: "Кейстер", services: "Қызметтер", about: "Мен жайлы", contact: "Байланыс" },
      ...
      cases: [],
      services: [
        { title: "Видео түсірілім", desc: "Бренд-видео, клип, іс-шара, Reels — кәсіби құрылғылармен түсірілім." },
        { title: "Монтаж & постпродакшн", desc: "Монтаж, түс-коррекция, саунд-дизайн және анимациялық тайтлдар." },
        { title: "Контент-видео", desc: "Әлеуметтік желілерге арналған тұрақты видеоконтент: Reels, Shorts, Stories." }
      ],
      stats: [
        { value: "3+", label: "Жыл тәжірибе" },
        { value: "100+", label: "Түсірілген видео" },
        { value: "9+", label: "Серіктес компания" }
      ]
    },
    ...
    ru: {
      ui: {
        nav: { cases: "Кейсы", services: "Услуги", about: "Обо мне", contact: "Контакты" },
      ...
      cases: [],
      services: [
        { title: "Видеосъёмка", desc: "Бренд-видео, клипы, мероприятия, Reels — профессиональное оборудование." },
        { title: "Монтаж & постпродакшн", desc: "Монтаж, цветокоррекция, саунд-дизайн и анимированные титры." },
        { title: "Контент-видео", desc: "Регулярный видеоконтент для соцсетей: Reels, Shorts, Stories." }
      ],
      stats: [
        { value: "3+", label: "Лет опыта" },
        { value: "100+", label: "Снятых видео" },
        { value: "9+", label: "Компаний-партнёров" }
      ]
    },
    ...
    en: {
      ui: {
        nav: { cases: "Cases", services: "Services", about: "About me", contact: "Contact" },
      ...
      cases: [],
      services: [
        { title: "Video production", desc: "Brand videos, music clips, events, Reels — shot with professional gear." },
        { title: "Editing & post-production", desc: "Editing, color grading, sound design and animated titles." },
        { title: "Content video", desc: "Ongoing video content for social media: Reels, Shorts, Stories." }
      ],
      stats: [
...
/* --- CASE_FILES-тен кейстерді автоматты құру: әр видео — жеке кейс --- */
(function () {
